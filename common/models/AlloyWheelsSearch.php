...
/**
 * AlloyWheelsSearch represents the model behind the search form about `common\models\AlloyWheels`.
 */
class AlloyWheelsSearch extends AlloyWheels
{
    /**
     * @inheritdoc
     */
