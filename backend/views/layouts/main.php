                        ...
                        <div class="navbar-inner">
                                ...
                                <ul class="navbar-nav">
                                        ...
                                        if (Yii::$app->session['post']['admin'] == 1) {
                                                ...
                                                <li>
                                                        ...
                                                        <ul>
                                                                ...
                                                                <li>
                                                                        <?= Html::a('<i class="fa fa-angle-double-right"></i> Our Products', ['/cms/testimonials/update?id=1'], ['class' => 'title']) ?>
                                                                </li>
                                        ...
                                        <?= Html::a('<i class="fa fa-sliders"></i> <span class="title">About</span>', ['/cms/about/update', 'id' => 1], ['class' => 'title']) ?>
                                                                                ...
                                                                                <li>
                                        <?= Html::a('<i class="fa fa-user"></i> <span class="title">Clients</span>', ['/cms/slider/index'], ['class' => 'title']) ?>
                                                                                </li>
